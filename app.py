...
BOT_TOKEN = os.getenv("BOT_TOKEN") # نحتاجه لجلب صور وأسماء اللاعبين
BASE_URL = os.getenv("RENDER_EXTERNAL_URL", "https://webbot-90as.onrender.com")
REDIRECT_URI = f"{BASE_URL}/callback"

# ذاكرة مؤقتة عشان ما نضغط على API ديسكورد
user_cache = {}

def get_user_info(user_id):
    """دالة تجيب صورة واسم اللاعب من ديسكورد باستخدام الايدي"""
    ...
    if resp.status_code == 200:
        ...
        user_cache[str(user_id)] = info # حفظها بالذاكرة
        return info
...
def get_top_users():
    try:
        with open("global_points.json", "r", encoding="utf-8") as f:
            ...
            top_10 = sorted_users[:10] # التوب 10
            
            # دمج النقاط مع الصور والأسماء
            enriched_top = []
